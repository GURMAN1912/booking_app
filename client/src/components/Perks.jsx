...
export default function Perks({selected,onChange}) {
  ...
  return (
            ...
            <div className="grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center">
                <input type="checkbox"  checked={selected.includes("entance")} name='entance' onChange={handleClick}/>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <span>Private entance</span>
              </label>{" "}
              <label className="border p-4 flex rounded-2xl gap-2 items-center">
                <input type="checkbox" name='Ac' checked={selected.includes("Ac")} onChange={handleClick}/>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
